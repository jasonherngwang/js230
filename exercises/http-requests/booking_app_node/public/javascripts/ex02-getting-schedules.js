// Using XHR -------------------------------------------------------------------
function availableSchedulesXhr() {
...
// availableSchedulesXhr();

// Using fetch -----------------------------------------------------------------
async function availableSchedulesFetch() {
...
availableSchedulesFetch();

// -----------------------------------------------------------------------------
// Further Exploration

// Wayne's solution
async function availableSchedulesAsyncAwait() {
  // Used to abort a web request
  const controller = new AbortController();
  const timeout = setTimeout(() => controller.abort(), 5000);

  try {
    // Asynchronously retrieve staff as JSON; process to JS objects.
    ...
    // Tally up counts of available schedules.
